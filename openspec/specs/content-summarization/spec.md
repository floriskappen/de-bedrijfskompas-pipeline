# content-summarization Specification

## Purpose
TBD - created by archiving change implement-content-summarization. Update Purpose after archive.
## Requirements
...
- Score, rate, or rank the company (`global-scoring` and other dossier-derived analytic stages are downstream).
